...
! function(a) {
    a(function() {
        ...
        d.scrollspy({
                ...
                offset: {
                    top: function() {
                        var c = b.offset().top,
                            ...
                            e = a(".fsl-docs-nav").height();
                            // e = a(".bs-docs-nav").height();
                        return this.top = c - e - d
                    },
                    bottom: function() {
                        return this.bottom = a(".fsl-docs-footer").outerHeight(!0)
            ...
            container: "body"
        }), a(".tooltip-test").tooltip(), a(".popover-test").popover(), a(".fsl-docs-navbar").tooltip({
        // }), a(".tooltip-test").tooltip(), a(".popover-test").popover(), a(".bs-docs-navbar").tooltip({
            selector: "a[data-toggle=tooltip]",
            container: ".fsl-docs-navbar .nav"
